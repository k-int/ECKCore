    	...
    	<div class="row-fluid">
	      	...
	      	<section id="main">
	        	...
	        	<div class="row">
	          		<div class="span12">
	          			<ul>
	                		<li><g:link base="${ModulesService.getModuleExternalPath(ModulesService.getCoreModuleCode())}" controller ="Test" action="aggregator">Core - Aggregator Statistics</g:link></li>
                			<li><g:link base="${ModulesService.getModuleExternalPath(ModulesService.getCoreModuleCode())}" controller ="Test" action="europeana">Core - Europeana</g:link></li>
